    ...
    <div class="content">
        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-footer">
                <a class="btn btn-default pull-left" href="/cuantitativos/F">Regresar</a>
            </div>
        </div>
        <div class="box box-warning box-solid">
            <div class="box-header"><h3 class="box-title">Seleccione las variables correspondientes a la Formula.</h3></div>
            <div class="box-body">
                {{ Form::open(['route' => ['formulaVariables.update',$formula->id],'method' => 'patch']) }}
                <div class="col-md-12">
                    ...
                    <table class="table table-responsive table-striped table-bordered table-hover table-checkable datatable" id="formulaVariables-table">
                        ...
                        @foreach($variables as $v)
                            <tr>
                                <td>{!! $v->variable !!}</td>
                                <td>
                                    {{ Form::checkbox('chkSelVariable[]', $v->id, in_array($v->id, $formulaVariables), ['class' => 'inputIcheck']) }}
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
