<div class="col-md-5 col-sm-4 col-md-offset-4 col-sm-offset-0">
    ...
    <!-- Tipo Unidad Id Field -->
    <div class="form-group col-sm-12">
        {!! Form::label('tipo_unidad_id', 'Tipo Unidad:') !!}
        {!! Form::select('tipo_unidad_id', $tipoUnidades, $unidad!=null?$unidad->tipo_unidad_id:1,['class' => 'form-control', 'required' => true]) !!}
    </div>

    <!-- Ubicacion Id Field -->
    <div class="form-group col-sm-12">
        {!! Form::label('ubicacion_id', 'Ubicacion:') !!}
        {!! Form::select('ubicacion_id', $ubicaciones, $unidad!=null?$unidad->ubicacion_id:1,['class' => 'form-control', 'required' => true]) !!}
    </div>
    ...
    <div class="form-group col-sm-12">
        ...
        <a href="{!! route('unidads.index') !!}" class="btn btn-default btnLoader">Cancel</a>
    </div>
</div>
