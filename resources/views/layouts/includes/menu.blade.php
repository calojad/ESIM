...
@if(Auth::user()->rol == 1)
    ...
    <li class="treeview {{ Request::is('matriz*','modelos*','criterios*','indicadors*','evidencias*','elementos*','estructura*') ? 'active' : '' }}">
        ...
        <ul class="treeview-menu">
            <li class="{{ Request::is('criterios*') ? 'active' : '' }}">
                <a href="{!! route('criterios.index') !!}" title="Criterios / Ejes Sustantivos"><i class="{{ Request::is('criterios*') ? 'fas' : 'far' }} fa-circle"></i><span>Criterios</span></a>
            </li>
            <li class="{{ Request::is('indicadors*') ? 'active' : '' }}">
                <a href="{!! route('indicadors.index') !!}" title="Indicadores / Estándares"><i class="{{ Request::is('indicadors*') ? 'fas' : 'far' }} fa-circle"></i><span>Indicadores</span></a>
            </li>
            <li class="{{ Request::is('evidencias*') ? 'active' : '' }}">
                <a href="{!! route('evidencias.index') !!}" title="Evidencias / Elementos Fundamentales"><i class="{{ Request::is('evidencias*') ? 'fas' : 'far' }} fa-circle"></i><span>Evidencias</span></a>
            </li>
            <li class="{{ Request::is('elementos*') ? 'active' : '' }}">
                <a href="{!! route('elementos.index') !!}" title="Elementos / Fuentes de Información"><i class="{{ Request::is('elementos*') ? 'fas' : 'far' }} fa-circle"></i><span>Elementos</span></a>
            </li>
    ...
    <li class="{{ Request::is('/home/matrices') ? 'active' : '' }}">
        <a class="btnLoader" href="{!! url('/home/matrices') !!}" title="Ver Matrices Asignadas para Evaluar"><i class="fa fa-list-alt font-14pt"></i><span>Matricez ha Evaluar</span></a>
    </li>
...
@else
    <li class="{{ Request::is('home*') ? 'active' : '' }}">
        <a class="btnLoader" href="{!! route('home') !!}"><i class="fa fa-home font-14pt"></i><span>Inicio</span></a>
    </li>
@endif